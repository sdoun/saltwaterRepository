...
class ExploreMapStore extends StatefulWidget {
  const ExploreMapStore({super.key});

  @override
  State<ExploreMapStore> createState() => _ExploreMapStoreState();
}

class _ExploreMapStoreState extends State<ExploreMapStore> {
  Future<QuerySnapshot> getPoints(){
    final querySnapshot = FirebaseFirestore.instance.collection('TB_point').where('point_categories', isEqualTo: '낚시방').get();
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  SizedBox(
                    height: 72,
                    child: Image.asset('assets/images/낚시방컬러.png'),
                  ),
                  Text('낚시방 검색하기',
                    style: FlutterFlowTheme
                        .of(context)
