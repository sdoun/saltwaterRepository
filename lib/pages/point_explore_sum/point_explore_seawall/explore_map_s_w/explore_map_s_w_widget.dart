...
import 'package:salt_water_beta_ver1/pages/weather_sum/weather_detailed/weather_detailed_widget.dart';
...
class _ExploreMapSWWidgetState extends State<ExploreMapSWWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.filterValueExit = !(_model.sW1stFilter == null && _model.sW2ndFilter == null && _model.sW3rdFilter == null && FFAppState().fishes.isEmpty);
    });
  ...
  void filterClear(){
    setState((){
        _model.sW1stFilter = null;
        _model.sW2ndFilter = null;
        _model.sW3rdFilter = null;
