...
import 'package:salt_water_beta_ver1/reusable/carrot/chatting/chatBubbles.dart';
                        ...
                        builder: (context, snapshot) {
                          ...
                          return ListView.separated(
                            ...
                            itemBuilder: (context, listViewIndex) {
                              ...
                              final isMine = listViewTBChatRecord.chatCreatedBy ==  currentUserReference?.id;
                              return ChatBubbles(
                                  message: listViewTBChatRecord.chatContent, 
                                  isMine: isMine);
                            },
                          );
                        },
